    ...
    return (
        <div className="home">
                        ...
                        <div className="row gx-4 gy-4 gx-lg-4">
                            ...
                            <div className="col-12 col-sm-6 col-lg-3">
                                <div className="award-card">
                                    ...
                                    <h3 className="epilogue-semibold">Phi Eta Sigma Honors Society</h3>
                                </div>
                            </div>
                            <div className="col-12 col-sm-6 col-lg-3">
                                <div className="award-card">
                                    <img src="./a3.svg" alt="Awards" />
                                    <h3 className="epilogue-semibold">Pittsburgh Today
                                        Live</h3>
                                </div>
                            </div>
                            <div className="col-12 col-sm-6 col-lg-3">
                    ...
                    <div className="projects-wrapper">
                        <div className="row gx-4 gy-4 gx-lg-4">
                            <div className="col-12 col-sm-12 col-lg-6 connect-text ">
                                ...
                                <p className="epilogue-regular">I am currently based in Pittsburgh, PA and I am currently in search for a full-time position </p>
                            </div>
            ...
            <div className="footer">
                <p className="epilogue-regular">© 2024 Rachel Sadeh. All rights reserved</p>
            </div>
        </div>
    );
}
