  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://rachelportfoliobackend.onrender.com/send-email",
        {
          method: "POST",
  ...
  return (
    <div className="home">
      ...
      <div className="introduction container py-5">
        <div className="row align-items-center">
          <div className="col-12 col-lg-6 text-center text-lg-start mb-4 mb-lg-0 px-4">
            ...
            <h1 className="epilogue-semibold">UX Designer & Researcher</h1>
        ...
        <div className="project-section px-3 px-md-5">
          <div className="projects-wrapper">
            <div className="row gx-4 gy-4 gx-lg-4">
              {[
                {
                  iconSet: ["/DP1A.png", "/DP1B.png"],
                  title: "Prioritizing the User",
                  summary:
                    "I foster a human-centric mindset, ensuring the team understands and prioritizes real people’s needs in design.",
                },
                {
                  iconSet: ["/DP2A.png", "/DP2B.png", "/DP2C.png"],
                  title: "Accessibility",
                  summary:
                    "I advocate for inclusive standards and patterns, ensuring usability, comprehension, and empowerment through education.",
                },
                {
                  iconSet: ["/DP3A.png", "/DP3B.png"],
                  title: "Empathy",
                  summary:
                    "I engage with teams, stakeholders, and clients to understand their unique, diverse perspectives and integrate them into my designs.",
                },
              ].map((item, idx) => (
                <PrinciplesCard
                  key={idx}
              ...
              <div className="col-12 col-sm-12 col-lg-6">
                <div className="connect-card">
                  <form onSubmit={handleSubmit} ref={formRef}>
                    ...
                    <h3 className="epilogue-light">Your Email</h3>
                    <div className="input-wrapper">
                      <input
                        type="email"
      ...
      <div className="footer">
        <p className="epilogue-regular">
          © 2025 Rachel Sadeh. All rights reserved
        </p>
      </div>
    </div>
  );
